...
namespace HannahsHunt.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index(IndexViewModel model)
        {
            ...
            //Update Claims
            await _userManager.AddUpdateClaimAsync(user, "FirstName", user.FirstName);
            await _userManager.AddUpdateClaimAsync(user, "LastName", user.LastName);
            await _userManager.AddUpdateClaimAsync(user, "FullName", user.FullName);
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("HannahsHunt2"),
